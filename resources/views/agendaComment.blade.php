...
<div class="container" style="padding:1em;margin-top:0%">
            ...
            <div class="user-img"> 
             <img src="{{ asset('images/agenda.png') }}" style="margin-left:10%;width:70px" alt="user" class="img-circle">
                    ...
                    <a href="/meeting/agenda/{{$invitingId}}/{{$meetingid}}" class="btn-rounded btn btn-primary btn-outline"><i class="ti-close text-primary m-r-5"></i>Back to agenda</a>
                    </div>
                    <!-- /.col-lg-12 -->
            </div>
    ...
    <div class="col-md-12 col-lg-8 col-lg-offset-2 col-sm-12" style="margin-left:125px">
            <div class="panel panel-default">
                ...
                <div class="flash-message">
                                            ...
                                            <textarea type="text" placeholder="Type you comments ...." rows="4" class="form-control col-sm-12 col-md-8 col-lg-8" name="comment" required>Type you comments ....</textarea>
                                                <p>
                                                    ...
                                                    <div class="comment-center p-t-10">
                                                            <div class="comment-body">
                                                                    ...
                                                                    <div class="mail-contnet">
                                                                        <h5>{{$comment->fullname}}
                                                                        </h5><span class="time">commented {{ date('F d, Y', strtotime($comment->created_at)) }}</span>
                                                                        <br/><span class="mail-desc">  {{$comment->comments}} </span>
