                                        ...
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                            ...
                                                            <form method="POST" action="/comments">
                                                                ...
                                                                <textarea type="text" onkeydown="autoResize(event)" style="overflow-y:hidden;" placeholder="Type you comments ...." rows="4" class="form-control col-sm-12 col-md-8 col-lg-8" name="comment"
                                                                    required></textarea>
                                                                <p>
